...
namespace Microsoft.DotNet.ProjectModel.Graph
{
    public class LockFile : IMergeable<LockFile>
    {
        ...
        public void MergeWith(LockFile fragmentLockFile)
        {
            ...
            Targets.MergeWith(fragmentLockFile.Targets, l => l.TargetFramework.Framework + l.RuntimeIdentifier);
            ...
            ProjectFileDependencyGroups.MergeWith(fragmentLockFile.ProjectFileDependencyGroups, pdg => pdg.FrameworkName?.Framework ?? "");
        }
    }
}